    ...
    return (
        Header(
            Nav(
                A(
                    Img(
                        src="/assets/logo/temp-logo-no-bg.png",
                        alt="Ashrei Wellness",
                        width="105",
                        height="24",
                    ),
        ...
        Section(
            ...
            Div(
                ...
                Div(
                    ...
                    P(
                        "Embrace a holistic approach to wellness with Ashrei. From personalized plans to community support, we help you achieve a balanced life.",
                ...
                Div(
                    A(
                        "Learn more",
                        href="https://about.ashreiwellness.com",
                        **_blank,
        ...
        Div(
            Div(
                ...
                Button(
                    Div(
                        Img(
                            cls="button-content w-4 h-4",
                            src="assets/icons/copy-icon.svg",
                            alt="Copy",
                        ),
                        Span(
                            "Copied!",
                            cls=f"absolute bg-inherit rounded-l-[0.5rem] {center} py-2 h-full right-0 copied-text overflow-hidden w-0 peer-clicked:w-fit s-body text-white/80 transition-transform transition-all duration-600 ease-out",
                        ),
...
async def component_preview_section():
    ...
    return Section(
        Div(
            Div(
                H2(
                    "This home page is an Ashrei Wellness app.",
                    cls="text-white heading-2 pt-8",
                ),
                P(
                    "Click the buttons below to see four small, live components in action.",
                    cls=f"text-white pt-8 l-body {maxrem(32)}",
                ),
                cls=f"{maxrem(50)} mx-auto {col} {center} text-center gap-6",
            ),
            *[
                code_demo(title, file_name, code_snippet, demo_content, i == 0)
                for i, (title, file_name, code_snippet, demo_content) in enumerate(cs)
            ],
            Ul(
                *[tab_button(title, i == 0) for i, (title, _, _, _) in enumerate(cs)],
                Div(
                    id="highlighter",
                    cls=f"{inset} z-0 highlighter w-[10.59375rem] absolute bg-white/20 h-[2.75rem] rounded-[62.5rem] transition-transform duration-300",
                ),
                role="tablist",
                id="tab-list",
...
def stacked_cards_section():
    return Section(
                ...
                Div(
                    ...
                    P(
                        ...
                        A(
                            ...
                            href="https://about.ashreiwellness.com/vision",
                            **_blank,
        ...
        Div(
            Div(
                *[
                    stacked_card(title, description, tech_stack, "bg-soft-green")
                    for title, description, tech_stack in stacked
                ],
                id="stacked-cards",
                cls=f"{maxrem(50)} mx-auto",
            ),
            cls="px-4 lg:px-16 w-full bg-green pt-8",
        ),
        id="stacked-cards-section",
        cls="relative",
    )


def samples_section():
    text = "Ashrei Wellness can be used for everything from personalized wellness plans to community support. We've selected small self-contained examples for you to learn from."
    return section_wrapper(
        (
            section_header(
                "SAMPLES", "See Ashrei Wellness in action", text, max_width=40
            ),
            Div(
                *[
                    Div(
                        A(
                            ...
                            Div(
                                P(
                                    name,
                                    cls="border-b-2 border-b-black/30 hover:border-b-black/80 regular-body",
                                ),
                                Img(
                                    src=f"{icons}/arrow-up-right.svg",
                                    alt="Arrow right icon",
                                    cls="group-hover:translate-y-[-0.1rem] transition-all ease-in-out duration-300",
                                ),
                                cls=f"{gap2} transition-transform transform relative items-center mt-4 lg:mt-6",
                            ),
                            href=url,
                            cls=f"{col} items-center",
                        ),
                        cls="group px-2",
                    )
...
def how_it_works_section():
    msg = "With Ashrei Wellness you create a balanced life through personalized wellness plans and community support."
    return section_wrapper(
        (
            Div(
                section_header(
                    "GET STARTED IN MINUTES",
                    "The fastest way to achieve a balanced life.",
                    msg,
                ),
    ...
    return section_wrapper(
        Div(
            section_header(
                "FAQ",
                "Questions? Answers.",
                "Your top Ashrei Wellness questions clarified.",
                max_width=21,
                center=False,
            ),
            Div(
    ...
    return section_wrapper(
        Div(
            section_header(
                ...
                "Our community members share their experiences with Ashrei Wellness.",
                max_width=21,
                center=False,
            ),
            carousel(
                [
                    testimonial_card(i, text, name, title, image_src)
                    for i, (text, name, title, image_src) in enumerate(testimonials)
                ]
            ),
...
def footer():
    return Section(
        Div(
            Div(
                P(
                    "© 2024 onwards Ashrei Wellness. All rights reserved.",
                    cls="mr-auto",
                ),
                Nav(
                    Ul(
                        footer_link(
                            "Github", "https://github.com/AshreiWellness", **_blank
                        ),
                        footer_link(
                            "Join Discord",
                            "https://discord.gg/ashreiwellness",
                            **_blank,
                        ),
                        footer_link(
                            "Docs", "https://docs.ashreiwellness.com", **_blank
                        ),
...
hdrs = [
    ...
    *Socials(
        title="Ashrei Wellness",
        description=description,
        site_name="ashreiwellness.com",
        twitter_site="@ashreiwellness",
...
async def home():
    return (
        Title(f"Ashrei Wellness - {description}"),
        Main(
            hero_section(),
